...
| `run_pope_eval.py`, `run_pope_eval_ugaa.py` | Earlier POPE eval drivers superseded by `scripts/run_pope_eval_full.py`. |
...
working set lives in `src/pope_audit/` (the installable `pope-audit`
package) and `scripts/` (the runnable drivers).
